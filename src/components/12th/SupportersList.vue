...
import supporters from "../../assets/json/12th/supporters.json";
import { computed, onMounted, ref } from 'vue';
const supportersArr = supporters.supporters;

const all = [...supportersArr];
const counter = ref(0);
...
const emit = defineEmits(['endSupporters']);
const emitter = () => {
    emit('endSupporters', true);
}
